...
```{r IntervalStepPlot, fig.width=9}
...
##  To Do:  Replace for() with sapply, time permitting
...
```{r ImputedHistogram, fig.width=9}
## prep histogram
...
```{r WdayWkendPlotMean, fig.width = 9}
...
```{r WkdayWkendPlotMax, fig.width = 9}
